...
public class ChatroomService {
        ...
        // 채팅방 생성
        public Integer createChatroom(Integer novelId, Integer episodeId, String chatTitle, String token) {
                System.out.println("DEBUG: createChatroom called with novelId=" + novelId + ", chatTitle=" + chatTitle
                ...
                if (episodeId == null || episodeId <= 0) {
                        System.out.println("DEBUG: Invalid novelId: " + episodeId);
                        throw new ResponseStatusException(
                                        HttpStatus.BAD_REQUEST, "episodeId가 올바르지 않은 형식입니다.");
                }
                ...
                Episode episode = episodeRepository.findById(episodeId).orElseThrow(
                                () -> new ResponseStatusException(
                                                HttpStatus.NOT_FOUND, "에피소드를 찾을 수 없습니다."));

                Chatroom chatroom = new Chatroom(chatTitle, user, novel, episode);
